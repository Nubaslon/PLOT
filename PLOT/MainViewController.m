...
- (void)viewDidLoad
{
    ...
    NSArray *prices = [[NSArray alloc] initWithObjects:@"24000", @"4000", @"15000", @"20000", @"3000", @"16000", @"21000", @"8000", @"22000", @"17000", @"5000", @"11000", @"2000", @"17000",@"20000",@"5000",@"18000",@"5000",@"23000",@"4000",@"6000",@"15000",@"22000",@"17000",@"7000",@"11000",@"20000",@"5000",@"10000",@"20000",@"16000",nil];
